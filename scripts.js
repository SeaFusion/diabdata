...
document.addEventListener("DOMContentLoaded", function () {
  ...
  ["u1", "u2", "u3", "u4", "u5", "u6"].forEach((id) =>
    populateSelectOptions(id, 0, 50)
  );
  ...
  document.addEventListener("input", function () {
    ...
    const ajoutRetrait =
      parseFloat(document.getElementById("ajout_retrait").value) || 0;
  ...
  window.submitForm = function () {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbwo4cxfY2y-XsKvUXI8WrHdZ1tT-E_7ZBc2yHS3I-llaJIg8svaPGYOSw1PLwxOVIyn/exec",
      {
        method: "POST",
        //mode:"no-cors",
